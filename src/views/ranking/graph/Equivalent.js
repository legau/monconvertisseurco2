  ...
  return (
    ...
    >
      ...
      <ChartWrapper>
        ...
        <Chart>
          <Bar
            percent={mounted ? props.equivalent.totalMultiplied / props.max : 0}
          >
            <Value
              noBar={props.equivalent.totalMultiplied / props.max === 0}
              inside={props.equivalent.totalMultiplied / props.max > 0.7}
            >
              <Number>{formatNumber(props.equivalent.totalMultiplied)}</Number>
              <Unit>
                {' '}
                kg CO
                <sub>2</sub>e
